...
<html lang="en">
<head>
   <title>Z B I Bank - Sabka Saath Sabka Vikas</title>
   <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">Z B I Bank   </a>
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>Z B I  Bank</h1>
      <p1> Z B I  Bank is a part of Z B I foundation. It is one of Zeurik nations's leading private banks and was among the first to receive approval from the Central bank of Zeurik nation (AUS) to set up a private sector bank in 992 ZY.
          Today, Z B I Bank has a banking network of 5,608 branches and 16,087 ATM's in 2,902 cities/towns. Z B I Bank offers a diverse range of financial products and banking services to customers(Which are dead actually, because they are Z B I) through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
...
<div class="py-5">
 ...
 <p1>This website is the
      ...
      acknowledged within the website. Anyone may reproduce, distribute, adapt, translate the content on the website, without explicit permission, provided that the content is accompanied by an acknowledgement that Z B I Bank website is the source and that it is clearly indicated if changes were made to the original content.</p1>
 </div>



<footer class="text-center mt-2 py-5">
        <p>&copy 2022  <b>Jai Pratap Mishra </b> </br>Chairman, Z B I Foundation</p>
      </footer>
